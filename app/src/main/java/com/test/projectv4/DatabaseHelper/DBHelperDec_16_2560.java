...
/**
 * Created by Administrator1 on 11/2/2561.
 */

public class DBHelperDec_16_2560 extends SQLiteOpenHelper {

    public static final String DBNAME = "16_12_60.sqlite";
    public static final String DBLOCATION = "/data/data/com.test.projectv4/databases/";
    private Context mContext;
    private SQLiteDatabase mDatabase;

    public DBHelperDec_16_2560(Context context){
